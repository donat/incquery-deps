...
public class DependencyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addFromPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				JavaModelPackage.Literals.DEPENDENCY__FROM, true, false, true, null, null, null));
	}
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				JavaModelPackage.Literals.DEPENDENCY__TO, true, false, true, null, null, null));
	}
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				JavaModelPackage.Literals.DEPENDENCY__TYPE, true, false, false,
	...
	public String getText(Object object) {
		...
		return dependency.getType() + " (from: " + dependency.getFrom().getName() + ", to:"
				+ dependency.getTo().getName() + ")";
//		String label = dependency == null ? null : dependency.toString();
