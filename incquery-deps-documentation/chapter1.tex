...
\todo{context}: complex software development
...
\todo{preciz smooth upgrade definicio}
...
\todo{explain the connection between smooth upgrade and dependency analysis}
...
\todo{CERN-specific requirements}
