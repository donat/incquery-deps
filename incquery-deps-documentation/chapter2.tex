...
The Oracle Database is a relational database management system (RDBMS) from the
Oracle Corporation. Originally developed in 1977 by Lawrence Ellison and other
...
Also known as Oracle DB, Oracle RDBMS, and sometimes just Oracle.
