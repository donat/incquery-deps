...
the Java platform and the internals of the Java binaries. In
\autoref{sect:serverside} we go through the softwares which were used to build
...
The followings aim to give an overview about the applied technologies and should 
be enough to understand the subsequent chapters.
...
\todo[inline]{Cite oracle documentation}
...
\todo[inline]{ECore overview comes here}

\subsection{Eclipse Modeling Framework}

\todo[inline]{Cite Istvan's TDK}
...
and university researches.\todo[inline]{KTM2011}
...
is the rich XText based editor for the query language which aids writing well
...
\todo[inline]{Xtext: hianyzik a hivatkozas!}
