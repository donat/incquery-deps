...
model).
Pom can be used to configure the entire build process, but he most importan part
is: dependency management, build customization,

Maven is customizable via plugins which can be done

Maven comes with a definition of a repository management. A maven repository can be 
...
0.14) and it is still under heavy development. The current modifications and
