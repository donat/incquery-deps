...
% TODO: this shoulcd be replaced with true slicing
...
int the workspace and keeps it synchronized along every workspace modification.
...
If a modification happens in the source file it is alsoincrementallyy modified
...
Prefixes for the code elements: makes sense in this part.
