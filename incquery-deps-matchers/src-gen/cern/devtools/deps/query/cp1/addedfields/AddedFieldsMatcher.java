...
import cern.devtools.deps.query.cp1.addedfields.AddedFieldsMatcherFactory;
...
public class AddedFieldsMatcher extends BaseGeneratedMatcher<AddedFieldsMatch> implements IncQueryMatcher<AddedFieldsMatch> {
  private final static int POSITION_WSFIELD = 0;
   ...
   * 
   */
  public Collection<AddedFieldsMatch> getAllMatches(final WField pWsField) {
    return rawGetAllMatches(new Object[]{pWsField});
  }
   ...
   * 
   */
  public AddedFieldsMatch getOneArbitraryMatch(final WField pWsField) {
    return rawGetOneArbitraryMatch(new Object[]{pWsField});
  }
   ...
   * 
   */
  public boolean hasMatch(final WField pWsField) {
    return rawHasMatch(new Object[]{pWsField});
  }
   ...
   * 
   */
  public int countMatches(final WField pWsField) {
    return rawCountMatches(new Object[]{pWsField});
  }
   ...
   * 
   */
  public void forEachMatch(final WField pWsField, final IMatchProcessor<? super AddedFieldsMatch> processor) {
    rawForEachMatch(new Object[]{pWsField}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final WField pWsField, final IMatchProcessor<? super AddedFieldsMatch> processor) {
    return rawForOneArbitraryMatch(new Object[]{pWsField}, processor);
  }
   ...
   * 
   */
  public DeltaMonitor<AddedFieldsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final WField pWsField) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pWsField});
  }
   ...
   * 
   */
  public AddedFieldsMatch newMatch(final WField pWsField) {
    return new AddedFieldsMatch(pWsField);
  ...
  public AddedFieldsMatch tupleToMatch(final Tuple t) {
    try {
    	return new AddedFieldsMatch((hu.bme.incquery.deps.wsmodel.WField) t.get(POSITION_WSFIELD));	
  ...
  public AddedFieldsMatch arrayToMatch(final Object[] match) {
    try {
    	return new AddedFieldsMatch((hu.bme.incquery.deps.wsmodel.WField) match[POSITION_WSFIELD]);
