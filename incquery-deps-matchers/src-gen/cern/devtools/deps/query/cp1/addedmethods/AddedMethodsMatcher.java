...
public class AddedMethodsMatcher extends BaseGeneratedMatcher<AddedMethodsMatch> implements IncQueryMatcher<AddedMethodsMatch> {
   ...
   * 
   */
  public Collection<AddedMethodsMatch> getAllMatches(final WMethod pWsMethod, final WType pWsClass) {
    return rawGetAllMatches(new Object[]{pWsMethod, pWsClass});
  }
   ...
   * 
   */
  public AddedMethodsMatch getOneArbitraryMatch(final WMethod pWsMethod, final WType pWsClass) {
    return rawGetOneArbitraryMatch(new Object[]{pWsMethod, pWsClass});
  }
   ...
   * 
   */
  public boolean hasMatch(final WMethod pWsMethod, final WType pWsClass) {
    return rawHasMatch(new Object[]{pWsMethod, pWsClass});
  }
   ...
   * 
   */
  public int countMatches(final WMethod pWsMethod, final WType pWsClass) {
    return rawCountMatches(new Object[]{pWsMethod, pWsClass});
  }
   ...
   * 
   */
  public void forEachMatch(final WMethod pWsMethod, final WType pWsClass, final IMatchProcessor<? super AddedMethodsMatch> processor) {
    rawForEachMatch(new Object[]{pWsMethod, pWsClass}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final WMethod pWsMethod, final WType pWsClass, final IMatchProcessor<? super AddedMethodsMatch> processor) {
    return rawForOneArbitraryMatch(new Object[]{pWsMethod, pWsClass}, processor);
  }
   ...
   * 
   */
  public DeltaMonitor<AddedMethodsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final WMethod pWsMethod, final WType pWsClass) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pWsMethod, pWsClass});
  }
   ...
   * 
   */
  public AddedMethodsMatch newMatch(final WMethod pWsMethod, final WType pWsClass) {
    return new AddedMethodsMatch(pWsMethod, pWsClass);
   ...
   * 
   */
  public Set<WMethod> getAllValuesOfwsMethod(final AddedMethodsMatch partialMatch) {
   ...
   * 
   */
  public Set<WMethod> getAllValuesOfwsMethod(final WType pWsClass) {
    WMethod pWsMethod = null;
    return rawAccumulateAllValuesOfwsMethod(new Object[]{pWsMethod, pWsClass});
  }
   ...
   * 
   */
  public Set<WType> getAllValuesOfwsClass(final AddedMethodsMatch partialMatch) {
   ...
   * 
   */
  public Set<WType> getAllValuesOfwsClass(final WMethod pWsMethod) {
    WType pWsClass = null;
    return rawAccumulateAllValuesOfwsClass(new Object[]{pWsMethod, pWsClass});
  }
  
  @Override
  public AddedMethodsMatch tupleToMatch(final Tuple t) {
    try {
    	return new AddedMethodsMatch((hu.bme.incquery.deps.wsmodel.WMethod) t.get(POSITION_WSMETHOD), (hu.bme.incquery.deps.wsmodel.WType) t.get(POSITION_WSCLASS));	
  ...
  public AddedMethodsMatch arrayToMatch(final Object[] match) {
    try {
    	return new AddedMethodsMatch((hu.bme.incquery.deps.wsmodel.WMethod) match[POSITION_WSMETHOD], (hu.bme.incquery.deps.wsmodel.WType) match[POSITION_WSCLASS]);
