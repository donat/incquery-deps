...
/**
 * Pattern-specific match representation of the incomingInheritances pattern, 
 * to be used in conjunction with IncomingInheritancesMatcher.
 * 
 ...
 * 
 */
public final class IncomingInheritancesMatch extends BasePatternMatch implements IPatternMatch {
  ...
  IncomingInheritancesMatch(final CP1Class pRepoSource, final WType pWsTarget) {
  ...
  public String patternName() {
    return "incomingInheritances";
    
  }
  
  @Override
  public String[] parameterNames() {
    return IncomingInheritancesMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!pattern().equals(otherSig.pattern()))
    	return false;
    if (!IncomingInheritancesMatch.class.equals(obj.getClass()))
    	return Arrays.deepEquals(toArray(), otherSig.toArray());
    IncomingInheritancesMatch other = (IncomingInheritancesMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return IncomingInheritancesMatcher.factory().getPattern();
