...
import cern.devtools.deps.query.cp1.incomingmethodcalls.IncomingMethodCallsMatcherFactory;
...
/**
 * Generated pattern matcher API of the incomingMethodCalls pattern, 
 ...
 * @see IncomingMethodCallsMatcherFactory
 * @see IncomingMethodCallsProcessor
 * 
 */
public class IncomingMethodCallsMatcher extends BaseGeneratedMatcher<IncomingMethodCallsMatch> implements IncQueryMatcher<IncomingMethodCallsMatch> {
   ...
   * 
   */
  public IncomingMethodCallsMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   * 
   */
  public IncomingMethodCallsMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a IncomingMethodCallsMatch object.
   * 
   */
  public Collection<IncomingMethodCallsMatch> getAllMatches(final CP1Method pRepoSource, final WMethod pWsTarget) {
   ...
   * @param pRepoSource the fixed value of pattern parameter repoSource, or null if not bound.
   * @param pWsTarget the fixed value of pattern parameter wsTarget, or null if not bound.
   * @return a match represented as a IncomingMethodCallsMatch object, or null if no match is found.
   * 
   */
  public IncomingMethodCallsMatch getOneArbitraryMatch(final CP1Method pRepoSource, final WMethod pWsTarget) {
   ...
   * 
   */
  public void forEachMatch(final CP1Method pRepoSource, final WMethod pWsTarget, final IMatchProcessor<? super IncomingMethodCallsMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final CP1Method pRepoSource, final WMethod pWsTarget, final IMatchProcessor<? super IncomingMethodCallsMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<IncomingMethodCallsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final CP1Method pRepoSource, final WMethod pWsTarget) {
   ...
   * 
   */
  public IncomingMethodCallsMatch newMatch(final CP1Method pRepoSource, final WMethod pWsTarget) {
    return new IncomingMethodCallsMatch(pRepoSource, pWsTarget);
   ...
   * 
   */
  public Set<CP1Method> getAllValuesOfrepoSource(final IncomingMethodCallsMatch partialMatch) {
   ...
   * 
   */
  public Set<WMethod> getAllValuesOfwsTarget(final IncomingMethodCallsMatch partialMatch) {
  ...
  @Override
  public IncomingMethodCallsMatch tupleToMatch(final Tuple t) {
    try {
    	return new IncomingMethodCallsMatch((hu.bme.incquery.deps.cp1model.CP1Method) t.get(POSITION_REPOSOURCE), (hu.bme.incquery.deps.wsmodel.WMethod) t.get(POSITION_WSTARGET));	
  ...
  @Override
  public IncomingMethodCallsMatch arrayToMatch(final Object[] match) {
    try {
    	return new IncomingMethodCallsMatch((hu.bme.incquery.deps.cp1model.CP1Method) match[POSITION_REPOSOURCE], (hu.bme.incquery.deps.wsmodel.WMethod) match[POSITION_WSTARGET]);
   ...
   * 
   */
  public static IMatcherFactory<IncomingMethodCallsMatcher> factory() throws IncQueryException {
    return IncomingMethodCallsMatcherFactory.instance();
  }
}
