...
import cern.devtools.deps.query.cp1.removedfields.RemovedFieldsMatcherFactory;
...
public class RemovedFieldsMatcher extends BaseGeneratedMatcher<RemovedFieldsMatch> implements IncQueryMatcher<RemovedFieldsMatch> {
   ...
   * 
   */
  public Collection<RemovedFieldsMatch> getAllMatches(final CP1Field pRepoField) {
    return rawGetAllMatches(new Object[]{pRepoField});
  }
   ...
   * 
   */
  public RemovedFieldsMatch getOneArbitraryMatch(final CP1Field pRepoField) {
    return rawGetOneArbitraryMatch(new Object[]{pRepoField});
  }
   ...
   * 
   */
  public boolean hasMatch(final CP1Field pRepoField) {
    return rawHasMatch(new Object[]{pRepoField});
  }
   ...
   * 
   */
  public int countMatches(final CP1Field pRepoField) {
    return rawCountMatches(new Object[]{pRepoField});
  }
   ...
   * 
   */
  public void forEachMatch(final CP1Field pRepoField, final IMatchProcessor<? super RemovedFieldsMatch> processor) {
    rawForEachMatch(new Object[]{pRepoField}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final CP1Field pRepoField, final IMatchProcessor<? super RemovedFieldsMatch> processor) {
    return rawForOneArbitraryMatch(new Object[]{pRepoField}, processor);
  }
   ...
   * 
   */
  public DeltaMonitor<RemovedFieldsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final CP1Field pRepoField) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pRepoField});
  }
   ...
   * 
   */
  public RemovedFieldsMatch newMatch(final CP1Field pRepoField) {
    return new RemovedFieldsMatch(pRepoField);
  ...
  public RemovedFieldsMatch tupleToMatch(final Tuple t) {
    try {
    	return new RemovedFieldsMatch((hu.bme.incquery.deps.cp1model.CP1Field) t.get(POSITION_REPOFIELD));	
  ...
  public RemovedFieldsMatch arrayToMatch(final Object[] match) {
    try {
    	return new RemovedFieldsMatch((hu.bme.incquery.deps.cp1model.CP1Field) match[POSITION_REPOFIELD]);
