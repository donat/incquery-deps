...
public final class ImpactCausedByRemovedMethodsMatch extends BasePatternMatch implements IPatternMatch {
  ...
  private CP1Method fRepoTo;
  
  private CP1DependencyType fType;
  
  private static String[] parameterNames = {"repoFrom", "repoTo", "type"};
  
  ImpactCausedByRemovedMethodsMatch(final CP1Method pRepoFrom, final CP1Method pRepoTo, final CP1DependencyType pType) {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("repoTo".equals(parameterName) && newValue instanceof hu.bme.incquery.deps.cp1model.CP1Method) {
    	this.fRepoTo = (hu.bme.incquery.deps.cp1model.CP1Method) newValue;
    	return true;
    }
  ...
  public void setRepoTo(final CP1Method pRepoTo) {
    this.fRepoTo = pRepoTo;
