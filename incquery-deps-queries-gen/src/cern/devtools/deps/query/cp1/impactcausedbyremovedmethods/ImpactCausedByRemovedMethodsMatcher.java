...
import cern.devtools.deps.query.cp1.impactcausedbyremovedmethods.ImpactCausedByRemovedMethodsMatcherFactory;
...
public class ImpactCausedByRemovedMethodsMatcher extends BaseGeneratedMatcher<ImpactCausedByRemovedMethodsMatch> implements IncQueryMatcher<ImpactCausedByRemovedMethodsMatch> {
   ...
   * 
   */
  public Collection<ImpactCausedByRemovedMethodsMatch> getAllMatches(final CP1Method pRepoFrom, final CP1Method pRepoTo, final CP1DependencyType pType) {
   ...
   * 
   */
  public ImpactCausedByRemovedMethodsMatch getOneArbitraryMatch(final CP1Method pRepoFrom, final CP1Method pRepoTo, final CP1DependencyType pType) {
   ...
   * 
   */
  public boolean hasMatch(final CP1Method pRepoFrom, final CP1Method pRepoTo, final CP1DependencyType pType) {
   ...
   * 
   */
  public int countMatches(final CP1Method pRepoFrom, final CP1Method pRepoTo, final CP1DependencyType pType) {
   ...
   * 
   */
  public void forEachMatch(final CP1Method pRepoFrom, final CP1Method pRepoTo, final CP1DependencyType pType, final IMatchProcessor<? super ImpactCausedByRemovedMethodsMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final CP1Method pRepoFrom, final CP1Method pRepoTo, final CP1DependencyType pType, final IMatchProcessor<? super ImpactCausedByRemovedMethodsMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<ImpactCausedByRemovedMethodsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final CP1Method pRepoFrom, final CP1Method pRepoTo, final CP1DependencyType pType) {
   ...
   * 
   */
  public ImpactCausedByRemovedMethodsMatch newMatch(final CP1Method pRepoFrom, final CP1Method pRepoTo, final CP1DependencyType pType) {
    return new ImpactCausedByRemovedMethodsMatch(pRepoFrom, pRepoTo, pType);
   ...
   * 
   */
  public Set<CP1Method> getAllValuesOfrepoFrom(final ImpactCausedByRemovedMethodsMatch partialMatch) {
   ...
   * 
   */
  public Set<CP1Method> getAllValuesOfrepoFrom(final CP1Method pRepoTo, final CP1DependencyType pType) {
   ...
   * 
   */
  public Set<CP1Method> rawAccumulateAllValuesOfrepoTo(final Object[] parameters) {
    Set<CP1Method> results = new HashSet<CP1Method>();
   ...
   * 
   */
  public Set<CP1Method> getAllValuesOfrepoTo() {
   ...
   * 
   */
  public Set<CP1Method> getAllValuesOfrepoTo(final ImpactCausedByRemovedMethodsMatch partialMatch) {
   ...
   * 
   */
  public Set<CP1Method> getAllValuesOfrepoTo(final CP1Method pRepoFrom, final CP1DependencyType pType) {
    CP1Method pRepoTo = null;
   ...
   * 
   */
  public Set<CP1DependencyType> getAllValuesOftype(final ImpactCausedByRemovedMethodsMatch partialMatch) {
   ...
   * 
   */
  public Set<CP1DependencyType> getAllValuesOftype(final CP1Method pRepoFrom, final CP1Method pRepoTo) {
  ...
  public ImpactCausedByRemovedMethodsMatch tupleToMatch(final Tuple t) {
    try {
    	return new ImpactCausedByRemovedMethodsMatch((hu.bme.incquery.deps.cp1model.CP1Method) t.get(POSITION_REPOFROM), (hu.bme.incquery.deps.cp1model.CP1Method) t.get(POSITION_REPOTO), (hu.bme.incquery.deps.cp1model.CP1DependencyType) t.get(POSITION_TYPE));	
  ...
  public ImpactCausedByRemovedMethodsMatch arrayToMatch(final Object[] match) {
    try {
    	return new ImpactCausedByRemovedMethodsMatch((hu.bme.incquery.deps.cp1model.CP1Method) match[POSITION_REPOFROM], (hu.bme.incquery.deps.cp1model.CP1Method) match[POSITION_REPOTO], (hu.bme.incquery.deps.cp1model.CP1DependencyType) match[POSITION_TYPE]);
