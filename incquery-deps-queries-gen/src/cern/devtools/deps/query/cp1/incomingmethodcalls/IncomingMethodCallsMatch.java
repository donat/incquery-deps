...
/**
 * Pattern-specific match representation of the incomingMethodCalls pattern, 
 * to be used in conjunction with IncomingMethodCallsMatcher.
 * 
 ...
 * 
 */
public final class IncomingMethodCallsMatch extends BasePatternMatch implements IPatternMatch {
  ...
  IncomingMethodCallsMatch(final CP1Method pRepoSource, final WMethod pWsTarget) {
  ...
  public String patternName() {
    return "incomingMethodCalls";
    
  }
  
  @Override
  public String[] parameterNames() {
    return IncomingMethodCallsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!pattern().equals(otherSig.pattern()))
    	return false;
    if (!IncomingMethodCallsMatch.class.equals(obj.getClass()))
    	return Arrays.deepEquals(toArray(), otherSig.toArray());
    IncomingMethodCallsMatch other = (IncomingMethodCallsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return IncomingMethodCallsMatcher.factory().getPattern();
