...
import cern.devtools.deps.query.cp1.removedmethod.RemovedMethodMatcherFactory;
...
public class RemovedMethodMatcher extends BaseGeneratedMatcher<RemovedMethodMatch> implements IncQueryMatcher<RemovedMethodMatch> {
   ...
   * 
   */
  public Collection<RemovedMethodMatch> getAllMatches(final CP1Method pRepoMethod) {
    return rawGetAllMatches(new Object[]{pRepoMethod});
  }
   ...
   * 
   */
  public RemovedMethodMatch getOneArbitraryMatch(final CP1Method pRepoMethod) {
    return rawGetOneArbitraryMatch(new Object[]{pRepoMethod});
  }
   ...
   * 
   */
  public boolean hasMatch(final CP1Method pRepoMethod) {
    return rawHasMatch(new Object[]{pRepoMethod});
  }
   ...
   * 
   */
  public int countMatches(final CP1Method pRepoMethod) {
    return rawCountMatches(new Object[]{pRepoMethod});
  }
   ...
   * 
   */
  public void forEachMatch(final CP1Method pRepoMethod, final IMatchProcessor<? super RemovedMethodMatch> processor) {
    rawForEachMatch(new Object[]{pRepoMethod}, processor);
  }
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final CP1Method pRepoMethod, final IMatchProcessor<? super RemovedMethodMatch> processor) {
    return rawForOneArbitraryMatch(new Object[]{pRepoMethod}, processor);
  }
   ...
   * 
   */
  public DeltaMonitor<RemovedMethodMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final CP1Method pRepoMethod) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pRepoMethod});
  }
   ...
   * 
   */
  public RemovedMethodMatch newMatch(final CP1Method pRepoMethod) {
    return new RemovedMethodMatch(pRepoMethod);
  ...
  public RemovedMethodMatch tupleToMatch(final Tuple t) {
    try {
    	return new RemovedMethodMatch((hu.bme.incquery.deps.cp1model.CP1Method) t.get(POSITION_REPOMETHOD));	
  ...
  public RemovedMethodMatch arrayToMatch(final Object[] match) {
    try {
    	return new RemovedMethodMatch((hu.bme.incquery.deps.cp1model.CP1Method) match[POSITION_REPOMETHOD]);
