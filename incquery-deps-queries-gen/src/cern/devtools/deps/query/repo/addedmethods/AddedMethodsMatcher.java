...
import cern.devtools.deps.query.repo.addedmethods.AddedMethodsMatcherFactory;
...
public class AddedMethodsMatcher extends BaseGeneratedMatcher<AddedMethodsMatch> implements IncQueryMatcher<AddedMethodsMatch> {
   ...
   * 
   */
  public Collection<AddedMethodsMatch> getAllMatches(final WMethod pC) {
   ...
   * 
   */
  public AddedMethodsMatch getOneArbitraryMatch(final WMethod pC) {
   ...
   * 
   */
  public boolean hasMatch(final WMethod pC) {
   ...
   * 
   */
  public int countMatches(final WMethod pC) {
   ...
   * 
   */
  public void forEachMatch(final WMethod pC, final IMatchProcessor<? super AddedMethodsMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final WMethod pC, final IMatchProcessor<? super AddedMethodsMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<AddedMethodsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final WMethod pC) {
   ...
   * 
   */
  public AddedMethodsMatch newMatch(final WMethod pC) {
    return new AddedMethodsMatch(pC);
   ...
   * 
   */
  public Set<WMethod> rawAccumulateAllValuesOfc(final Object[] parameters) {
   ...
   * 
   */
  public Set<WMethod> getAllValuesOfc() {
  ...
  public AddedMethodsMatch tupleToMatch(final Tuple t) {
    try {
    	return new AddedMethodsMatch((hu.bme.incquery.deps.wsmodel.WMethod) t.get(POSITION_C));	
  ...
  public AddedMethodsMatch arrayToMatch(final Object[] match) {
    try {
    	return new AddedMethodsMatch((hu.bme.incquery.deps.wsmodel.WMethod) match[POSITION_C]);
