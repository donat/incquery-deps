...
/**
 * Pattern-specific match representation of the incomingClassUsageDeps pattern, 
 * to be used in conjunction with IncomingClassUsageDepsMatcher.
 * 
 ...
 * 
 */
public final class IncomingClassUsageDepsMatch extends BasePatternMatch implements IPatternMatch {
  ...
  IncomingClassUsageDepsMatch(final RClass pFrom, final RClass pTo, final WType pWsTo) {
    this.fFrom = pFrom;
    this.fTo = pTo;
    this.fWsTo = pWsTo;
  ...
  public String patternName() {
    return "incomingClassUsageDeps";
    
  }
  
  @Override
  public String[] parameterNames() {
    return IncomingClassUsageDepsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!pattern().equals(otherSig.pattern()))
    	return false;
    if (!IncomingClassUsageDepsMatch.class.equals(obj.getClass()))
    	return Arrays.deepEquals(toArray(), otherSig.toArray());
    IncomingClassUsageDepsMatch other = (IncomingClassUsageDepsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return IncomingClassUsageDepsMatcher.factory().getPattern();
