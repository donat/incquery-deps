...
import cern.devtools.deps.query.repo.incomingmethodcalldeps.IncomingMethodCallDepsMatcherFactory;
...
/**
 * Generated pattern matcher API of the incomingMethodCallDeps pattern, 
 ...
 * @see IncomingMethodCallDepsMatcherFactory
 * @see IncomingMethodCallDepsProcessor
 * 
 */
public class IncomingMethodCallDepsMatcher extends BaseGeneratedMatcher<IncomingMethodCallDepsMatch> implements IncQueryMatcher<IncomingMethodCallDepsMatch> {
   ...
   * 
   */
  public IncomingMethodCallDepsMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   * 
   */
  public IncomingMethodCallDepsMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * @return matches represented as a IncomingMethodCallDepsMatch object.
   * 
   */
  public Collection<IncomingMethodCallDepsMatch> getAllMatches(final RMethod pFrom, final RMethod pTo, final WMethod pWsTo) {
   ...
   * @param pTo the fixed value of pattern parameter to, or null if not bound.
   * @param pWsTo the fixed value of pattern parameter wsTo, or null if not bound.
   * @return a match represented as a IncomingMethodCallDepsMatch object, or null if no match is found.
   * 
   */
  public IncomingMethodCallDepsMatch getOneArbitraryMatch(final RMethod pFrom, final RMethod pTo, final WMethod pWsTo) {
   ...
   * 
   */
  public void forEachMatch(final RMethod pFrom, final RMethod pTo, final WMethod pWsTo, final IMatchProcessor<? super IncomingMethodCallDepsMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final RMethod pFrom, final RMethod pTo, final WMethod pWsTo, final IMatchProcessor<? super IncomingMethodCallDepsMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<IncomingMethodCallDepsMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final RMethod pFrom, final RMethod pTo, final WMethod pWsTo) {
   ...
   * 
   */
  public IncomingMethodCallDepsMatch newMatch(final RMethod pFrom, final RMethod pTo, final WMethod pWsTo) {
    return new IncomingMethodCallDepsMatch(pFrom, pTo, pWsTo);
   ...
   * 
   */
  public Set<RMethod> getAllValuesOffrom(final IncomingMethodCallDepsMatch partialMatch) {
   ...
   * 
   */
  public Set<RMethod> getAllValuesOfto(final IncomingMethodCallDepsMatch partialMatch) {
   ...
   * 
   */
  public Set<WMethod> getAllValuesOfwsTo(final IncomingMethodCallDepsMatch partialMatch) {
  ...
  @Override
  public IncomingMethodCallDepsMatch tupleToMatch(final Tuple t) {
    try {
    	return new IncomingMethodCallDepsMatch((hu.bme.incquery.deps.repomodel.RMethod) t.get(POSITION_FROM), (hu.bme.incquery.deps.repomodel.RMethod) t.get(POSITION_TO), (hu.bme.incquery.deps.wsmodel.WMethod) t.get(POSITION_WSTO));	
  ...
  @Override
  public IncomingMethodCallDepsMatch arrayToMatch(final Object[] match) {
    try {
    	return new IncomingMethodCallDepsMatch((hu.bme.incquery.deps.repomodel.RMethod) match[POSITION_FROM], (hu.bme.incquery.deps.repomodel.RMethod) match[POSITION_TO], (hu.bme.incquery.deps.wsmodel.WMethod) match[POSITION_WSTO]);
   ...
   * 
   */
  public static IMatcherFactory<IncomingMethodCallDepsMatcher> factory() throws IncQueryException {
    return IncomingMethodCallDepsMatcherFactory.instance();
  }
}
