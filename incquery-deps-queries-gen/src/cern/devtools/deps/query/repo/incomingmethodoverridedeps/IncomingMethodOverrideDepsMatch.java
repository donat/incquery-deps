...
/**
 * Pattern-specific match representation of the incomingMethodOverrideDeps pattern, 
 * to be used in conjunction with IncomingMethodOverrideDepsMatcher.
 * 
 ...
 * 
 */
public final class IncomingMethodOverrideDepsMatch extends BasePatternMatch implements IPatternMatch {
  ...
  IncomingMethodOverrideDepsMatch(final RMethod pFrom, final RMethod pTo, final WMethod pWsTo) {
    this.fFrom = pFrom;
    this.fTo = pTo;
    this.fWsTo = pWsTo;
  ...
  public String patternName() {
    return "incomingMethodOverrideDeps";
    
  }
  
  @Override
  public String[] parameterNames() {
    return IncomingMethodOverrideDepsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!pattern().equals(otherSig.pattern()))
    	return false;
    if (!IncomingMethodOverrideDepsMatch.class.equals(obj.getClass()))
    	return Arrays.deepEquals(toArray(), otherSig.toArray());
    IncomingMethodOverrideDepsMatch other = (IncomingMethodOverrideDepsMatch) obj;
  ...
  public Pattern pattern() {
    try {
    	return IncomingMethodOverrideDepsMatcher.factory().getPattern();
