...
import cern.devtools.deps.query.repo.removedclasses.RemovedClassesMatcherFactory;
...
public class RemovedClassesMatcher extends BaseGeneratedMatcher<RemovedClassesMatch> implements IncQueryMatcher<RemovedClassesMatch> {
   ...
   * 
   */
  public Collection<RemovedClassesMatch> getAllMatches(final RClass pC) {
   ...
   * 
   */
  public RemovedClassesMatch getOneArbitraryMatch(final RClass pC) {
   ...
   * 
   */
  public boolean hasMatch(final RClass pC) {
   ...
   * 
   */
  public int countMatches(final RClass pC) {
   ...
   * 
   */
  public void forEachMatch(final RClass pC, final IMatchProcessor<? super RemovedClassesMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final RClass pC, final IMatchProcessor<? super RemovedClassesMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<RemovedClassesMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final RClass pC) {
   ...
   * 
   */
  public RemovedClassesMatch newMatch(final RClass pC) {
    return new RemovedClassesMatch(pC);
   ...
   * 
   */
  public Set<RClass> rawAccumulateAllValuesOfc(final Object[] parameters) {
   ...
   * 
   */
  public Set<RClass> getAllValuesOfc() {
  ...
  public RemovedClassesMatch tupleToMatch(final Tuple t) {
    try {
    	return new RemovedClassesMatch((hu.bme.incquery.deps.repomodel.RClass) t.get(POSITION_C));	
  ...
  public RemovedClassesMatch arrayToMatch(final Object[] match) {
    try {
    	return new RemovedClassesMatch((hu.bme.incquery.deps.repomodel.RClass) match[POSITION_C]);
