...
The result pair is indicated with red squares on the figure.

\paragraph{Development-time results}
During the development the EMF-IncQuery tooling is capable of evaluating the
queries on top of example instance models. One can use the \emph{Query
Explorer} to visualize the results in Eclipse. 
...
TBD: click on an element: instantly gives back all incoming d


\subsubsection{Model validation with on-the-fly queries}
here comes the kraken. the validation part.
