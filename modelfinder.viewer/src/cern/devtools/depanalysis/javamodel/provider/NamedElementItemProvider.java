...
/**
 * This is the item provider adapter for a {@link cern.devtools.depanalysis.javamodel.NamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JavaModelPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addHandlerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamedElement_handler_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NamedElement_handler_feature", "_UI_NamedElement_type"),
				 JavaModelPackage.Literals.NAMED_ELEMENT__HANDLER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
