...
public class FieldImpl extends NamedElementImpl implements Field {
	...
	public ApiClass getClass_() {
		if (eContainerFeatureID() != JavaModelPackage.FIELD__CLASS) return null;
	...
	public NotificationChain basicSetClass(ApiClass newClass, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newClass, JavaModelPackage.FIELD__CLASS, msgs);
		return msgs;
	}
	...
	public void setClass(ApiClass newClass) {
		if (newClass != eInternalContainer() || (eContainerFeatureID() != JavaModelPackage.FIELD__CLASS && newClass != null)) {
			...
			if (newClass != null)
				msgs = ((InternalEObject)newClass).eInverseAdd(this, JavaModelPackage.API_CLASS__FIELDS, ApiClass.class, msgs);
			msgs = basicSetClass(newClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaModelPackage.FIELD__CLASS, newClass, newClass));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case JavaModelPackage.FIELD__CLASS:
				return eInternalContainer().eInverseRemove(this, JavaModelPackage.API_CLASS__FIELDS, ApiClass.class, msgs);
		}
