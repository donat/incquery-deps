...
public class JavaModelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case JavaModelPackage.WORKSPACE: {
			...
			case JavaModelPackage.DEPENDENCY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Api Class</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Api Class</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseApiClass(ApiClass object) {
		return null;
	}
