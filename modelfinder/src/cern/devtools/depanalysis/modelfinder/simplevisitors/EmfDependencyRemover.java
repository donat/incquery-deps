...
public class EmfDependencyRemover extends Identity {
	private final Workspace workspace;

	private EmfDependencyRemover(Workspace workspace) {
	...
	public static EmfDependencyRemover newInstance(Workspace workspace) {
		return new EmfDependencyRemover(workspace);
	}
