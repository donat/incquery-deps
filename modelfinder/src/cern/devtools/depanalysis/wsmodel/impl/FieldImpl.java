 ...
 * <ul>
 *   <li>{@link cern.devtools.depanalysis.wsmodel.impl.FieldImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FieldImpl extends NamedElementImpl implements Field {
	 ...
	 */
	public Type getType() {
		if (eContainerFeatureID() != JavaModelPackage.FIELD__TYPE) return null;
	...
	public NotificationChain basicSetType(Type newType, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newType, JavaModelPackage.FIELD__TYPE, msgs);
		return msgs;
	}
	...
	public void setType(Type newType) {
		if (newType != eInternalContainer() || (eContainerFeatureID() != JavaModelPackage.FIELD__TYPE && newType != null)) {
			...
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, JavaModelPackage.TYPE__FIELDS, Type.class, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JavaModelPackage.FIELD__TYPE, newType, newType));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case JavaModelPackage.FIELD__TYPE:
				return eInternalContainer().eInverseRemove(this, JavaModelPackage.TYPE__FIELDS, Type.class, msgs);
		}
