...
public class JavaModelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JavaModelPackage.JAVA_PROJECT: {
				...
				if (result == null) result = caseNamedElement(javaProject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JavaModelPackage.ECLIPSE_WORKSPACE: {
				EclipseWorkspace eclipseWorkspace = (EclipseWorkspace)theEObject;
				T result = caseEclipseWorkspace(eclipseWorkspace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JavaModelPackage.PACKAGE_FRAGMENT_ROOT: {
				PackageFragmentRoot packageFragmentRoot = (PackageFragmentRoot)theEObject;
				T result = casePackageFragmentRoot(packageFragmentRoot);
				if (result == null) result = caseNamedElement(packageFragmentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JavaModelPackage.PACKAGE_FRAGMENT: {
				PackageFragment packageFragment = (PackageFragment)theEObject;
				T result = casePackageFragment(packageFragment);
				if (result == null) result = caseNamedElement(packageFragment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JavaModelPackage.COMPILATION_UNIT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Eclipse Workspace</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Eclipse Workspace</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEclipseWorkspace(EclipseWorkspace object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePackageFragmentRoot(PackageFragmentRoot object) {
		return null;
	}
